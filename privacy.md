...
<div class="page-content" style="max-width: 800px; margin: 0 auto; padding-top: 20px;">
  ...
  <div style="color: var(--text); line-height: 1.6;">
    ...
    <h3 style="color: var(--accent); margin-top: 30px;">1. The Short Version</h3>
    <p>I respect your privacy. This website does not use tracking cookies, does not run invasive analytics, and does not sell your personal data. It is designed to be as lightweight and privacy-respecting as possible.</p>

    <h3 style="color: var(--accent); margin-top: 30px;">2. Data Collection</h3>
    ...
    <ul>
      ...
      <li><strong>Upvote System:</strong> To prevent spam and ensure each visitor can only vote once per blog post, the custom Cloudflare Worker powering the upvote button processes your IP address. Your IP is instantly cryptographically hashed; it is never stored in plain text. Only this anonymized hash is securely stored in a Cloudflare KV database to prevent duplicate votes.</li>
    ...
    <h3 style="color: var(--accent); margin-top: 30px;">3. Third-Party Services & Security</h3>
    ...
    <p>Email correspondence is used strictly to reply to your inquiries. If you contribute to a document on this website, your public avatar and username are displayed to credit your edits. The upvote system processes and stores anonymized hash data solely to maintain accurate vote counts and prevent spam abuse.</p>
    ...
    <h3 style="color: var(--accent); margin-top: 30px;">6. Your Rights</h3>
    <p>If you have sent me an email and would like your information permanently deleted from my records, simply <a href="/contact/" style="color: var(--accent); text-decoration: underline;">contact me</a> and I will remove it immediately.</p>
