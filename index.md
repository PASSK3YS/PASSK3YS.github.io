    ...
    <div class="grid-item" id="spotify-card" style="grid-column: 1 / -1; position: relative; overflow: hidden;">
        ...
        <div style="position: relative; z-index: 1;">
            <div class="spotify-header">
                ...
                <a href="http://googleusercontent.com/spotify.com/5" target="_blank" class="spotify-logo-link">
        ...
        .then(data => {
            ...
            if (data.music) {
                ...
                if (currentSpotifyState !== newState) {
                    ...
                    const searchUrl = `http://googleusercontent.com/spotify.com/6{encodeURIComponent(data.music.title + ' ' + data.music.artist)}`;
