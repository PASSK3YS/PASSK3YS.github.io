...
.ytm-text-logo {
    width: 44px;
    height: 26px;
    background-image: url('https://commons.wikimedia.org/wiki/Special:FilePath/YouTube_Music_2024.svg');
