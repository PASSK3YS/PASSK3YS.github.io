...
permalink: /cy/tools/recommendations/
---
...
.grid-cynhwysydd {
    arddangos: grid;
    grid-templed-colofnau: ailadrodd (awto-lenwi, minmax (250px, 1fr));
    bwlch: 20px;
    ymyl-brig: 30px;
}
...
.grid-eitem a {
    addurno testun: dim;
    didreiddedd: 0.8;
    pontio: didreiddedd 0.3s rhwyddineb, lliw 0.3s rhwyddineb;
}
