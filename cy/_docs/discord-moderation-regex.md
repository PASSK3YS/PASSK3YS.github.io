...
Mae'r patrwm regex hwn yn blocio awtomataidd "Nitro Am Ddim," "Digwyddiad Cymunedol Steam," a chysylltiadau gollwng cerdyn rhodd ffug, gan gynnwys y rhai sy'n defnyddio homoglyffau Cyrillig i osgoi hidlwyr safonol (ee,`s7e@m`).
...
Mae'r patrwm regex hwn yn rhwystro sgamwyr rhag osgoi hidlwyr gan ddefnyddio cromfachau system ffug, llwythi tâl amgodio URL sero-lled, hypergysylltiadau Markdown ffug, neu pings`@everyone`anawdurdodedig.
